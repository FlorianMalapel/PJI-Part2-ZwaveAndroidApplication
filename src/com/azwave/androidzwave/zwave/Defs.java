...
public class Defs {
	...
	// Put a controller into learn mode for replication receipt of configuration
	...
	// Remove returns routes to the SUC
	public static final byte FUNC_ID_ZW_DELETE_SUC_RETURN_ROUTE = (byte) 0x55;
	// Try to retrieve a Static Update Controller node id (zero if no SUC)
	public static final byte FUNC_ID_ZW_GET_SUC_NODE_ID = (byte) 0x56;
	// Allow options for request node neighbor
	public static final byte FUNC_ID_ZW_REQUEST_NODE_NEIGHBOR_UPDATE_OPTIONS = (byte) 0x5a;
	...
	// Ckeck to see if a specified node has failed
	...
	public static final byte FUNC_ID_SERIAL_API_SLAVE_NODE_INFO = (byte) 0xA0;
	...
	public static final byte FUNC_ID_ZW_SEND_SLAVE_NODE_INFO = (byte) 0xA2;
	...
	public static final byte SLAVE_ASSIGN_NODEID_DONE = (byte) 0x01;
	// Node is doing neighbor discovery
	public static final byte SLAVE_ASSIGN_RANGE_INFO_UPDATE = (byte) 0x02;
	// Disable add/remove virtual slave nodes
	public static final byte SLAVE_LEARN_MODE_DISABLE = (byte) 0x00;
	// Enable ability to include/exclude virtual slave nodes
	public static final byte SLAVE_LEARN_MODE_ENABLE = (byte) 0x01;
	// Add node directly but only if primary/inclusion controller
	public static final byte SLAVE_LEARN_MODE_ADD = (byte) 0x02;
	// Remove node directly but only if primary/inclusion controller
	public static final byte SLAVE_LEARN_MODE_REMOVE = (byte) 0x03;
