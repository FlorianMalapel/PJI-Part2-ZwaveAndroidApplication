...
/**
 * Manage all the Node on the Zwave network.
 */
public class NodeManager {
	...
	/**
	 * Create several Msg in the QueueManager to initialize the usb Zwave
	 * controller.
	 */
	public void init() {
	...
	/**
	 * Create a Node and add it to the Vector<Node>
	 * @param homeId of the Node
	 * @param nodeId 
	 * @return
	 */
	...
	/**
	 * Remove a Node of the Vector<Node>.
	...
	/**
	 * Create an ArrayList<Node> of all the Node in the Vector and return it.
	 * 
	 * @return ArrayList which contains all the Node of the network.
	 */
	...
	/**
	 * Create an ArrayList<Node> of all the Node alive in the Vector and return it.
	 * 
	 * @return ArrayList which contains all the Node alive of the network.
	 */
