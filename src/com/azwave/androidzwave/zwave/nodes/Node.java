...
public class Node {
	...
	/**
	 * Get Informations on the Node in the xml ressources.
	 * @param basic
	 * @param generic
	 * @param specific
	 */
	...
	/**
	 * Test if the Node is a Controller.
	 * @return True if the Node is Controller, else False.
	 */
	...
	/**
	 * Test if the Node is a listening device.
	 * @return
	 */
	...
	/**
	 * Set off a binary switch device.
	 */
	public void setOff() {
		Basic cc = (Basic) ccManager.getCommandClass(Basic.COMMAND_CLASS_ID);
		if (cc != null) {
