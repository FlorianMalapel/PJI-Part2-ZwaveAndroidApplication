...
/**
 * Represent a functionaly Alarm for a Node with its different command: GET, REPORT
 * And the different functions needed to communicate with the Node
 */
public class Alarm extends CommandClass {
	...
	/**
	 * Allow to use the command Report, and refresh the value of the CommandClass
	 * Alarm.
	 * 
	 * @return false if it's not a Report command in parameter
	 * @return true if it's the Report command in parameter
	 */
	@Override
	...
	/**
	 * Send a message to request a value.
	 * @return true if the Msg is sent
	 * @return false if the Msg is not sent
	 */
	@Override
	...
	/**
	 * Create a Value of type Byte with the informations of the class in the 
	 * Node's ValueManager.
	 */
	@Override
