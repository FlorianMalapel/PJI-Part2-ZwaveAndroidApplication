...
/**
 * CommandClass of type Basic, it's the basic functionality of a Node.
 * (Set, get, report)
 */
public class Basic extends CommandClass {
	...
	/**
	 * Allow to send a message to request the value of this class with
	 * the command BASIC_CMD_GET.
	 */
	...
	/**
	 * Allow to send data (Value) to the zwave device.
	...
	/**
	 * Create a Value of type Byte in the ValueManager
	 */
