...
/**
 * Manage a List of QueueItem by their priority and position, each of the
 * QueueItem have a Msg to transmit to the Controller
 */
public class QueueManager {
	...
	/**
	 * Create a new QueueItem with the command QueryStageComplete and add an
	 * item in the PriorityBlockingQueue Queue
	 * 
	 * @param nodeId : id of the node which request the methode
	 * @param query
	 */
	...
	/**
	 * Create a QueueItem and add it to list of the message to send.
	 * @param msg : the Msg to send
	 * @param priority : the priority of the QueueItem
	 */
	...
	/**
	 * Send a ControllerCommand.
	 * @param command : the ControllerCommand to send
	 * @param highPower
	 * @param nodeId
	 * @return
	 */
	...
	/**
	 * Send a ControllerCommand.
	 * @param cci the ControllerCommand to send
