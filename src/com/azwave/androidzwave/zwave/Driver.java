...
/**
 * Class which allow communications, by sending/receving data from the Zwave usb controller.
...
public class Driver implements IOServiceListener {
	 ...
	 * @param queueManager is the class which handle the message to send & receive
	 * @param nodeManager is the class which manager the all the Nodes
	 * @param xmlmanager
	 * @param serialDriver
	 * @param log
	 */
	...
	/**
	 * Initialize services needed by the driver.
	 * @throws IOException
	 */
	...
	/**
	 * Shutdown services use by the driver.
	 */
	public void close() {
		ioService.terminate();
	...
	/**
	 * @return the list of nodes on the Zwave network
	 */
	...
	/*
	 * Method which handle receiving data.
	 */
	@Override
	...
	/*
	 * Method which handle sending data
	 */
	@Override
	...
	/**
	 * Get the message to send in the QueueManager, condition it and give it
	 * to the method writeMsg(Msg msg).
	 * @throws IOException
	 */
	...
	/**
	 * Send the message in paramerter
	...
	/**
	 * Get an array of bytes in parameter, find the signification of it and
